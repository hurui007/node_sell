<template>
  <div class="header">
    <div class="content-wrapper">
      <div class="avatar">
        <img width="64px" height="64" v-bind:src="seller.avatar"/>
      </div>
      <div class="content">
        <div class="title">
        ...
        <div class="detail-main">
          ...
          <ul v-if="seller.supports" class="supports">
            ...
            <li class="support-item" v-for="(item,i) in seller.supports">
              <span class="icon" v-bind:class="classMap[seller.supports[i].type]"></span>
    ...
    .content-wrapper
      ...
      .content
        ...
        .title
          ...
          .brand
            vertical-align:top // 设置图片brand 顶部对齐
            width: 30px
            height: 18px
            display:inline-block //  只有行内元素才能体现宽和高度
            bg-image('brand')
